...
var pomodoro = {
  ...
  init : function() {
    ...
    $('#setSession').click(function(){
      self.startSetSession.apply(self);
    });
    $('#setBreak').click(function(){
      self.startSetBreak.apply(self);
    });
    $('#stop').click(function(){
  ...
  startSetSession: function() {
    this.resetVariables(25, 0, true);
  },
  startSetBreak: function(){
  ...
  updateDom: function() {
    this.minutesDom.text(this.toDoubleDigits(this.minutes));
